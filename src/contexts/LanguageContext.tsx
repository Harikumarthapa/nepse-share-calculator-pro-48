...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'app.h1': 'NEPSE Share Calculator – Detailed Fees, Tax & ROI for Every Trade',
    'app.h2': 'Share Buy & Sell Calculator for NEPSE Trades',
  ...
  ne: {
    'app.title': 'सेयर क्याल्कुलेटर नेपाल – नेप्से खरिद/बिक्री कर र शुल्क',
    'app.description': 'नेप्सेको लागि सटीक सेयर क्याल्कुलेटर। तुरुन्तै आफ्नो खरिद/बिक्री नाफा, पूँजीगत लाभ कर (CGT), शुल्क र ROI गणना गर्नुहोस्। नेपाली लगानीकर्ताहरूद्वारा विश्वसनीय।',
    'app.tagline': 'एक पूर्ण नेप्से सेयर क्याल्कुलेटर जसमा ब्रोकर कमिशन, डिपी शुल्क, सेबोन शुल्क, पूँजीगत लाभ कर र ROI समावेश छ।',
    'app.h1': 'नेप्से सेयर क्याल्कुलेटर – हरेक ट्रेडको विस्तृत शुल्क, कर र ROI',
    'app.h2': 'नेप्से ट्रेडको लागि सेयर खरिद र बिक्री क्याल्कुलेटर',
    ...
    'faq.wacc.answer': 'नेप्से सन्दर्भमा WACC (Weighted Average Cost of Capital) मूल्य भनेको तपाईंले कम्पनीको सेयर प्राप्त गरेको औसत मूल्य हो, जसमा सबै क
ारोबार लागतहरू समावेश छन्।',

...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ results, inputs }) => {
  ...
  const handleDownloadPDF = () => {
    ...
    // Clone DOM to customize header/footer without altering screen content
    ...
    header.innerHTML = `
      <div style="display: flex; align-items: center; justify-content: center; gap: 6px; font-size: 16px; font-weight: bold;">
        <img src="https://sharecalculator.app/favicon.ico" style="width: 18px; height: 18px;" />
  ...
  const handleDownloadPNG = async () => {
    ...
    try {
      ...
      if (ctx) {
        ...
        ctx.fillText(
          `Generated by ShareCalculator.App on ${formattedDate()}`,
          canvas.width / 2,
          canvas.height - 10
        );
      }

...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ results, inputs }) => {
  ...
  wrapper.style.background = '#fdfdfd';
  wrapper.style.fontFamily = 'Arial, sans-serif';

  // Watermark
  const watermark = document.createElement('div');
  watermark.innerText = 'ShareCalculator.App';
  ...
  header.innerHTML = `<div style="font-size: 20px; font-weight: bold; text-align: center; border-bottom: 1px solid #ddd; padding-bottom: 8px; margin-bottom: 16px;">
  ...
  footer.innerHTML = `<div style="font-size: 16px; text-align: center; color: #777; border-top: 1px solid #ddd; padding-top: 10px; margin-top: 20px;">

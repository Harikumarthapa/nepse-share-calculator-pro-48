...
const Privacy: React.FC = () => {
  ...
  useEffect(() => {
    // Update page title
    document.title = "Privacy Policy - Share Calculator Nepal";
    ...
    setupMetaImage('og:title', 'Privacy Policy - Share Calculator Nepal');
    setupMetaImage('og:description', 'Our privacy policy outlines how Share Calculator handles your data.');

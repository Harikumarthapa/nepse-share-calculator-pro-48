...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    // Update page title
    document.title = "Contact Us - Share Calculator Nepal";
    ...
    setupMetaImage('og:title', 'Contact Us - Share Calculator Nepal');
    setupMetaImage('og:description', 'Get in touch with the Share Calculator team for support or inquiries.');

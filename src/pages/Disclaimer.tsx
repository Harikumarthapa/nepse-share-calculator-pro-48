...
const Disclaimer: React.FC = () => {
  ...
  useEffect(() => {
    // Update page title
    document.title = "Disclaimer - Share Calculator Nepal";
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Important disclaimer for Share Calculator users - our tool provides estimates only and should not be considered financial or investment advice.");
    }
    ...
    setupMetaImage('og:title', 'Disclaimer - Share Calculator Nepal');
    setupMetaImage('og:description', 'Important disclaimer for Share Calculator users.');

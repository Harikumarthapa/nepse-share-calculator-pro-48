...
const About: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setupMetaImage('og:title', 'About Share Calculator - NEPSE Investment Tool');
    setupMetaImage('og:description', 'Learn about our mission to provide transparent NEPSE transaction information.');
